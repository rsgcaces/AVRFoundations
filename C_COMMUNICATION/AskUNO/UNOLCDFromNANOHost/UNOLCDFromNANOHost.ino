// PROJECT  :UNOLCDFromNANOHost
// PURPOSE  :Stage 2 of the 2020/2021 TEI3M Ask UNO project
// DEVICE   :UNO+LCD Appliance+NANO+LCD
// AUTHOR   :C. D'Arcy
// DATE     :2020 10 30
// uC       :*
// COURSE   :ICS3U
...
void setup() {
  ...
  lcd.print("UNO Assistant");    //provide an instruction on the first line
  chat.begin(9600);
  while(!chat);
}
